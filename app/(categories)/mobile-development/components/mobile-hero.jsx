...
import { Apple, CalendarRange } from "lucide-react";
...
export default function MobileHeroSection() {
  const [displayText, setDisplayText] = useState("Mobile App");
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="flex flex-col items-center space-y-4 text-lg md:text-xl text-gray-400">
            <p className="text-center text-2xl max-w-lg mx-5">
              Specialized in creating powerful, user-friendly mobile
              applications for{" "}
              <span className="inline-flex items-center gap-2 ">
                <BsAndroid2 className="text-[#3DDC84] h-6 w-6 mt-2" />

                <Apple className="text-[#A2AAAD] h-6 w-6 mt-2" />
              </span>
            </p>
          </div>
        </div>
